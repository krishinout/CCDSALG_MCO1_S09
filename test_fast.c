/**
    ...
    Driver program for the fast version of Graham Scan (using MergeSort).
...
/*  
    ...
    d. Purpose: this function is the driver program for fast Graham Scan.
...
int main(){
    ...
    //Compute the convex hull using the fast Graham Scan version
    grahamFast(points, n, convexHull, &convexHullSize);
