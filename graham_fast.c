/**
    ...
    To compute the convex hull using Graham Scan with MergeSort (fast version).
*/
...
/*  
    ...
    d. Purpose: this function will compute the convex hull using Graham Scan with MergeSort (fast).
    e. Return: None
    f. Parameters: 
...
*/
void grahamFast(Point points[], int n, Point convexHull[], int *convexHullSize){
    ...
    */
    ...
    // General case, using Graham Scan.
        ...
        */
        ...
        /* 
         (3) Sort all points using MergeSort except the anchor by its polar angles.
        - points+1 shifts array so index 0 of sorted array is points[1]
         of the original.
        - n-2 Bounds because there are (n-1) elements to sort.
        */
    ...
    */
    ...
    printf("Fast version execution time: %.6f ms\n", totalTime); 
}
